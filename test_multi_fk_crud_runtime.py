...
project = ProjectContext(
    project_name="multi_fk_nullable_runtime_test",
    root_path=Path("workspace/multi_fk_nullable_runtime_test"),
)
...
pedido_create_path = (
    Path("workspace/multi_fk_nullable_runtime_test")
...
print()
print("=" * 60)
print("VALIDANDO RUNTIME SQLITE")
print("=" * 60)
...
# Runtime aislado SQLite
os.environ["DB_DRIVER"] = "sqlite"
os.environ["DB_URL"] = "sqlite:///./runtime_test.db"


backend_path = backend_root / "backend/main.py"


# Limpiar imports backend anteriores
for key in list(sys.modules.keys()):
    if key.startswith("backend"):
        del sys.modules[key]


# Import normal del backend generado
import backend.main as generated_main

print()
print("DEBUG BACKEND MAIN:")
print(generated_main.__file__)

print("DEBUG ROUTES INTERNAS:")
for r in generated_main.app.routes:
    print(r)

from fastapi import FastAPI


# Reconstruir aplicación para expandir routers correctamente
app = FastAPI(
    title="VIERNES Generated API Runtime"
)

app.include_router(
    generated_main.usuario_router
)

app.include_router(
    generated_main.pedido_router
)
...
print()
print("=" * 60)
print("CREANDO TABLAS SQLITE RUNTIME")
print("=" * 60)
...
print()
print("=" * 60)
print("RUTAS FASTAPI DISPONIBLES")
print("=" * 60)
...
print("CREATE USUARIO:", response.status_code)
print(response.json())
...
# Crear pedido con aprobador NULL
...
print("CREATE PEDIDO NULL FK:", response.status_code)
print(response.json())
...
assert data["creado_por_id"] == usuario_id
assert data["aprobado_por_id"] is None
